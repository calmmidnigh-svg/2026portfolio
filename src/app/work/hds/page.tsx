        ...
        <div className={styles.container}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <p className={styles.text}>
                  입사 당시 제품 개발은 러프한 기획안만을 기반으로 디자이너 없이 진행되고 있었습니다. 앞으로 3~4개 제품이 추가될 예정이었으나 현 구조로는 확장이 불가능한 상황이었습니다.
                </p>
              </div>
            </div>
          ...
          <div className={styles.body} style={{ paddingTop: 0 }}>
            <div className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                ...
                <p className={styles.text}>화면 일관성의 근본 원인인 색상, 타이포, 간격을 먼저 정의했습니다.</p>
                <ul className={styles.bullets}>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <p className={styles.text}>
                  가장 어려웠던 점은 디자인 시스템을 만드는 것이 아니라 팀이 실제로 쓰게 만드는 것이었습니다. 아무리 잘 만들어도 쓰지 않으면 의미가 없었고, 초반에는 효용을 증명하기가 쉽지 않았습니다. 일방적으로 규칙을 강요하는 대신, 디자인 시스템 경험이 있는 개발자와 함께 규칙을 하나씩 맞춰가며 팀 전체가 속도가 빨라지는 걸 직접 체감하도록 했습니다.
                </p>
                <p className={styles.text}>
                  디자인 시스템은 결국 협업의 언어라는 걸 배웠습니다. 기술적 완성도보다 팀이 신뢰하고 함께 발전시켜 나가는 구조를 만드는 것이 핵심이었고, 그 과정이 가장 어렵고 가장 중요한 작업이었습니다.
                </p>
              </div>
            </div>
          </div>
