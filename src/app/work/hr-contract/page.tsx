...
const GALLERY_IMAGES = [
  { src: '/images/contract4.png', alt: 'HR전자계약서 화면 1' },
    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <div className={styles.imageFull} style={{ overflow: 'hidden', position: 'relative', height: '576px' }}>
          <Image src="/images/contract_main.png" alt="HR전자계약서 화면" fill style={{ objectFit: 'cover' }} priority sizes="(max-width: 1023px) 100vw, 1024px" />
        </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.imageFull}>
            <Image src="/images/contract2.png" alt="HR전자계약서 작업 화면" width={4096} height={1916} style={{ width: '100%', height: 'auto', display: 'block' }} sizes="(max-width: 1023px) 100vw, 1024px" />
          </div>
          ...
          {/* 이미지 */}
          <div className={styles.imageFull}>
            <Image src="/images/contract3.png" alt="HR전자계약서 작업 화면 3" width={4171} height={2304} style={{ width: '100%', height: 'auto', display: 'block' }} sizes="(max-width: 1023px) 100vw, 1024px" />
          </div>
          ...
          {/* 이미지 갤러리 */}
          <WorkImageGallery images={GALLERY_IMAGES} />
