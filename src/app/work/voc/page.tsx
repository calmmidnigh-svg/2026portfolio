        ...
        <div className={styles.header}>
          ...
          <table className={styles.overviewTable}>
            <tbody>
              ...
              <tr><td>기술</td><td>Rocket.Chat API + Gemini AI + 대시보드</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <ul className={styles.bullets}>
                  <li>요구사항은 데이터에서 나온다. 분류 기준을 만들기 위해 데이터를 먼저 읽어야 했다.</li>
                  <li>AI가 잘못 분류하는 코너케이스를 의식하고, 입력 데이터의 질을 정의하는 것이 분류 정확도에 직결된다.</li>
                  <li>사용자(내부 팀)이 데이터를 신뢰하려면 자동 분류 결과를 직접 수정할 수 있는 툴이 필요하다.</li>
                </ul>
              </div>
            </div>
          </div>
